// polyglot_random.h — the official Polyglot Random64 table (781 entries).
// Source: http://hgm.nubati.net/book_format.html (also reproduced in many engines).
// Public domain — these constants ARE the Polyglot book format.
//
// Layout (per Polyglot spec):
//   [  0..767]  piece-square keys: 64*piece + square
//                piece order: bp, wp, bn, wn, bb, wb, br, wr, bq, wq, bk, wk
//   [768..771]  castling rights: WHITE_OO, WHITE_OOO, BLACK_OO, BLACK_OOO
//   [772..779]  en-passant file (a..h)
//   [780]       turn (XOR-ed when white to move)
#pragma once
#include <cstdint>

constexpr uint64_t POLYGLOT_RANDOM64[781] = {
